...
main(int argc, char *argv[]) {
  ...
  10:	39c080e7          	jalr	924(ra) # 3a8 <getreadcount>
  14:	892a                	mv	s2,a0

    int rc = fork();
  16:	00000097          	auipc	ra,0x0
  1a:	2e2080e7          	jalr	738(ra) # 2f8 <fork>
  ...
  34:	2e8080e7          	jalr	744(ra) # 318 <read>
    for (i = 0; i < 100000; i++) {
  ...
  4a:	2ba080e7          	jalr	698(ra) # 300 <exit>
        (void) wait(&rc);
  4e:	fdc40513          	addi	a0,s0,-36
  52:	00000097          	auipc	ra,0x0
  56:	2b6080e7          	jalr	694(ra) # 308 <wait>
        int x2 = getreadcount();
  5a:	00000097          	auipc	ra,0x0
  5e:	34e080e7          	jalr	846(ra) # 3a8 <getreadcount>
        printf("XV6_TEST_OUTPUT %d\n", total);
  62:	412505bb          	subw	a1,a0,s2
  66:	00000517          	auipc	a0,0x0
  6a:	7da50513          	addi	a0,a0,2010 # 840 <malloc+0xf2>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 400:	46450513          	addi	a0,a0,1124 # 860 <digits>
 404:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4cc:	398b8b93          	addi	s7,s7,920 # 860 <digits>
 ...
 60c:	25090913          	addi	s2,s2,592 # 858 <malloc+0x10a>
        while(*s != 0){
