...
00000000000001de <main>:
{
 ...
 252:	81258593          	addi	a1,a1,-2030 # a60 <malloc+0xe4>
 256:	4509                	li	a0,2
 ...
 288:	7fc50513          	addi	a0,a0,2044 # a80 <malloc+0x104>
...
putc(int fd, char c)
{
 ...
 5fc:	f4e080e7          	jalr	-178(ra) # 546 <write>
}
...
malloc(uint nbytes)
{
 ...
 a54:	b5e080e7          	jalr	-1186(ra) # 5ae <sbrk>
  if(p == (char*)-1)
