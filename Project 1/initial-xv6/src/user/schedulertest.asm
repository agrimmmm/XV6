...
int main()
{
  ...
  42:	88a50513          	addi	a0,a0,-1910 # 8c8 <malloc+0x10a>
...
putc(int fd, char c)
{
 ...
 43e:	f4e080e7          	jalr	-178(ra) # 388 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 470:	48450513          	addi	a0,a0,1156 # 8f0 <digits>
 474:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 53c:	3b8b8b93          	addi	s7,s7,952 # 8f0 <digits>
 ...
 67c:	27090913          	addi	s2,s2,624 # 8e8 <malloc+0x12a>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 896:	b5e080e7          	jalr	-1186(ra) # 3f0 <sbrk>
  if(p == (char*)-1)
